...
parser.add_argument("--alpha1", type=float, default=0.443213638879763, help="alpha in dropout")
parser.add_argument("--alpha2", type=float, default=0.97910038141774, help="alpha in dropout")
parser.add_argument("--rtol", type=float, default=0.00002589645383511, help="rtol in diffeq")
parser.add_argument("--time", type=float, default=4.35438404978174)
parser.add_argument("--wd", type=float, default=0.0220034449883241)
...
graph = torch_geometric.datasets.Planetoid(root='../', name='citeseer')[0]
...
class Net(torch.nn.Module):
    def __init__(self, mask, front_initial, time, **kwargs):
        ...
        self.run_pde = False
        self.fzero = None
        self.m1 = Linear(kwargs["inp"],784,weight_initializer='glorot')
        self.m2 = Linear(784,256,weight_initializer='glorot')#64
        self.m3 = Linear(256,kwargs["out"], weight_initializer='glorot')
...
model.load_state_dict(torch.load("citeseer.pt"))
...
print(tmp_test_acc.item(), file=open("citeseer.txt","a"))
