...
parser.add_argument("--alpha1", type=float, default=0.174907729810044, help="alpha in dropout")
parser.add_argument("--alpha2", type=float, default=0.400899124203731, help="alpha in dropout")
parser.add_argument("--lr", type=float, default=0.00651708444487322)
parser.add_argument("--rtol", type=float, default=0.00234841720608179, help="rtol in diffeq")
parser.add_argument("--wd", type=float, default=0.000103417079247449)
parser.add_argument("--itr", type=int, default=100)
parser.add_argument("--time", type=float, default=5.2)
parser.add_argument("--lamb", type=float, default=2.7)
...
class Net(torch.nn.Module):
    def __init__(self, mask, front_initial, time, **kwargs):
        ...
        self.run_pde = False
        self.fzero = None
        self.m1 = Linear(kwargs["inp"],36,weight_initializer='kaiming_uniform')
        self.m2 = Linear(36,kwargs["out"], weight_initializer='kaiming_uniform')
...
model.load_state_dict(torch.load("fmasia.pt"))
...
print(tmp_test_acc.item(), file=open("fmasia.txt","a"))
